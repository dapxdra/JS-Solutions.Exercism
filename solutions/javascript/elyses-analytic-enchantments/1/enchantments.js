...
export function isEachCardEven(stack) {
  let isEven = (currentVal) => currentVal % 2 == 0;
...
export function doesStackIncludeOddCard(stack) {
  let oddN = (curr) => curr % 2 === 1;
  return stack.some(oddN);
}
...
export function getFirstOddCard(stack) {
  let oddC = (curr) => curr % 2 === 1;
  return stack.find(oddC);
}
...
export function getFirstEvenCardPosition(stack) {
  let evenC = (curr) => curr % 2 == 0;
  return stack.findIndex(evenC);
}
